user_name = input("Hei bro type in your name as shown eg- 'Kutta Paul'")
...
Note: words are not case sensative.

''').lower()
    if user_input == "add":
        x, y = input("Enter two numbers to add seperated by a space. eg '5  10': ").split()
        ans = int(x) + int(y)
        print(f'The sum is: {ans}')
    elif user_input == "subtract":
        x, y = input("Enter two numbers to subtract seperated by a space. eg '5  10': ").split()
        ans = int(x) - int(y)
        print(f'The ans is: {ans}')
    elif user_input == "multiply":
        x, y = input("Enter two numbers to multiply seperated by a space. eg '5  10': ").split()
        ans = int(x) * int(y)
        print(f'The ans is: {ans}')
    elif user_input == "div":
        x, y = input("Enter two numbers to divide seperated by a space. eg '5  10': ").split()
        ans = int(x) / int(y)
        print(f'The ans is: {ans}')
